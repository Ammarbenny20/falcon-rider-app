// mobile/src/screens/passenger/JourneysListScreen.tsx
...
export default function JourneysListScreen() {
  ...
  useEffect(() => {
    journeyApi.list().then((res) => setJourneys(res.results)).finally(() => setLoading(false));
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.empty}>No journeys yet. Search a destination to get started.</Text>}
      />
    </View>
  );
}
